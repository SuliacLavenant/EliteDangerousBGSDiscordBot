...
class CreateSetMinorFactionAsLeaderInSystemMissionModal(discord.ui.DesignerModal):
    minor_faction: str
    system: System

    def __init__(self, system: System):
        super().__init__(title=f"Create Set Leader Mission On System")
        self.system = system
        ...
        self.minor_faction_select = discord.ui.Label(label="Minor Faction To Set As Leader:").set_select(
            options=options,
            min_values=1,
            max_values=1,
            default_values=None,
